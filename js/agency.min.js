...
const $=jQuery.noConflict();$(window).scroll((function(){$(this).scrollTop()>1e3?($(".masthead").removeClass("parallax"),$("#contact").addClass("parallax")):($(".masthead").addClass("parallax"),$("#contact").removeClass("parallax"))}));